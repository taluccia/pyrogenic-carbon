...
ci1 = as.character(expression(95*"%"~CI*":"~-33.0~to~-10.6))
...
# The 95% CI of the difference
ci2 = as.character(expression(95*"%"~CI*":"~-23.8~to~-6.2))
# Put these into a single column of a data.frame
...
# The 95% CI of the difference
ci3 = as.character(expression(95*"%"~CI*":"~-0.15~to~0.17))
# Put these into a single column of a data.frame
...
```{r fig.height=7, fig.width=6}
p4 = p1 + 
  draw_plot(legend_b, x =.70, y = .59, width = .3, height = .3) + 
  draw_grob(t1,x =.16, y = .80, width = .25, height = .25, scale=.5) +
  draw_grob(t2,x =.185, y = .465, width = .25, height = .25, scale=.5) +
  draw_grob(t3,x =.653, y = .135, width = .25, height = .25, scale=.5)

p4
```

```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-07-09_PyC_live-dead_t-test.jpeg", plot = p4, width = 6, height = 7, units = c("in"), dpi=600 )
```
